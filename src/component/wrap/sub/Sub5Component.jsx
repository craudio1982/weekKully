...
export default function Sub5Component(props) {
    ...
    const onSubmitSignup = (e) => {
        ...
        // formDate.append('php변수', 상태변수)
        formDate.append('userId', state.아이디);
        formDate.append('userPw', state.비밀번호);
        formDate.append('userName', state.이름);
        formDate.append('userEmail', state.이메일 );
        formDate.append('userHp', state.휴대폰);
        formDate.append('userPostcode', state.우편번호);
        formDate.append('userAddr1', state.주소1);
        formDate.append('userAddr2', state.주소2);
        formDate.append('userGender', state.성별);
        formDate.append('userYear', state.생년);
        formDate.append('userMonth', state.생월);
        formDate.append('userDate', state.생일);
        formDate.append('userChooga', state.추가입력사항);
        formDate.append('userChamyeoEvent', state.참여이벤트명);
        formDate.append('userChoochuninId', state.추천인아이디);

        axios({
            url : 'http://saturn2846.dothome.co.kr/weekKully/signup_insert_react.php',
            methos : 'POST',
            data : formDate
                            ...
                            <ul className='signup-form'>
                                ...
                                <li className='list address1'>
                                    <div className="list-box">
                                        ...
                                        <div className="input-box autoHeight">                                            
                                        ...
                                        <div className="input-box">
                                            ...
                                            <label htmlFor="userChooga2">
                                                <input 
                                                    ...
                                                    id='userChooga2' 
                                                    value={'참여 이벤트명'} 
                                                    onChange={onChangeChamyeoEvent}
                                                    checked = {state.참여이벤트명.includes('참여 이벤트명')}
                                                />
                                                <span>참여 이벤트명</span>
                                            </label>                                            
                                        </div>
